...
await conn.sendHydrated(m.chat, gata, wm, null, md, '𝗪𝗮𝗶𝗳𝘂𝗡𝗲𝗸𝗼-𝗕𝗼𝘁', null, null, [
['💵 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙓10', '.buy2 10'],
['💸 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙓20', '.buy2 20'],
['⚡ 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙘𝙤𝙣 𝙀𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙘𝙞𝙖', '/buy']
    ...
    await conn.sendHydrated(m.chat, `*No tiene sufuciente 𝙂𝘼𝙏𝘼𝘾𝙊𝙄𝙉𝙎 para comprar ${count} Diamantes* 💎\n\n*Le recomiendo que interactúe con WaifuNeko-Bot para Obtener GataCoins, puede ver sus GataCoins con el comando ${usedPrefix}gatacoins o ${usedPrefix}experiencia. También puede comprar con su Experiencia con el Comando ${usedPrefix}buy*`, wm, null, ig, '𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢', null, null, [
['🐈 𝘾𝙤𝙢𝙥𝙧𝙖𝙧 𝙘𝙤𝙣 𝙀𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙘𝙞𝙖', '/buy'],
